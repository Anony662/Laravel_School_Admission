    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Department Edit</h4>
                    ...
                    <form action="{{ route('admin.departments.update', $department->id) }}" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $department->name) }}" placeholder="Enter Department Name" required>
                            </div>
                            <div class="form-group col-md-6 col-sm-12">
                        ...
                        <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">Update Department</button>
                    </form>
                </div>
            </div>
        </div>
