                ...
                <div class="card-body">
                    ...
                    <p class="float-right mb-2">
                        @if (Auth::guard('admin')->user()->can('department.create'))
                            <a class="btn btn-primary text-white" href="{{ route('admin.departments.create') }}">Create New Department</a>
                        @endif
                    </p>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        @if (Auth::guard('admin')->user()->can('department.edit'))
                                            <a class="btn btn-success text-white" href="{{ route('admin.departments.edit', $department->id) }}">Edit</a>
                                        @endif
                                        
                                        @if (Auth::guard('admin')->user()->can('department.delete'))
                                            <a class="btn btn-danger text-white" href="{{ route('admin.departments.destroy', $department->id) }}"
