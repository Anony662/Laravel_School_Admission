    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Create Message</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.message.index') }}">All Messages</a></li>
                    <li><span>Create Message</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Create New Message</h4>
                    ...
                    <form action="{{ route('admin.message.store') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">Send Message</button>
                    </form>
                </div>
            </div>
        </div>
